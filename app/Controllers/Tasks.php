...
class Tasks extends BaseController
{
    ...
    { 
        ...
        $data = $this->model->paginateTaskById($this->current_user->id);
    ...
    public function create() 
    {
        ...
        if ($this->model->insert($task)){
            ...
            return redirect()->to("/tasks/show/{$this->model->insertID}")
                             ->with("info",lang('Tasks.created_successful')); 
        } else {
...
*/
        ...
        if ($task === null) {
            ...
            throw new \CodeIgniter\Exceptions\PageNotFoundException(lang('Tasks.task_not_found'));
        }
        return $task;
    }
}
